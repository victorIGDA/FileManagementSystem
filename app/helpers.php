...
function remember_input(array $input): void { unset($input['contrasena'], $input['password'], $input['_csrf']); $_SESSION['_old'] = $input; }
function clear_old(): void { unset($_SESSION['_old']); }
function require_csrf(): void
{
    if (!Csrf::validate($_POST['_csrf'] ?? null)) { http_response_code(419); exit('La sesión del formulario expiró. Regresa e inténtalo de nuevo.'); }
}
