...
<div class="page-heading profile-page-heading">
    <div>
        ...
        <h1>Mi perfil</h1>
        <p>
            Administra tu fotografía, información personal y contraseña.
        </p>
    </div>
</div>
...
<div class="profile-stack">
    ...
    >
        ...
        <div class="profile-avatar-shell">
            <label
                ...
                for="foto"
                title="Seleccionar una fotografía"
            >
                <?php if ($user['foto_perfil']): ?>
                    <img
                        class="profile-avatar-preview"
                        id="profilePhotoPreview"
                        src="<?= url('/perfil/foto/' . $user['foto_perfil']) ?>"
                        alt="Fotografía de <?= e($user['nombre_usuario']) ?>"
                    >
                    <span
                        class="profile-avatar-initial d-none"
                        id="profilePhotoInitial"
                    >
                        <i
                ...
                <?php else: ?>
                    <img
                        class="profile-avatar-preview d-none"
                        id="profilePhotoPreview"
            ...
            <input
                ...
                data-max-bytes="<?= (int) App\Core\Env::get(
                    'MAX_PROFILE_MB',
                    3
                ) * 1024 * 1024 ?>"
            >
        ...
        <div class="profile-identity">
            ...
            <span
                ...
                id="profilePhotoFeedback"
            >
                Haz clic sobre la foto o el lápiz para cambiarla.
            </span>
        </div>
        ...
        <div class="profile-fields row g-3">
            ...
            <div class="col-md-6">
                ...
                <div class="readonly-field">
                    ...
                    <span>
                        JPG, PNG o WEBP · Máx.
                        <?= e(App\Core\Env::get('MAX_PROFILE_MB', 3)) ?>
                        MB
                    </span>
                </div>
            </div>
        ...
        <button
            class="btn btn-primary profile-submit"
            id="profileSubmit"
            type="submit"
        >
    ...
    <form
        class="panel password-card"
        method="post"
        action="<?= url('/perfil/contrasena') ?>"
    >
        <?= csrf_field() ?>
        ...
        <div class="row g-3 password-grid">
            <div class="col-lg-4">
                <label class="form-label" for="contrasena_actual">
                ...
                <div class="password-input-wrap">
                    ...
                    <button
                        type="button"
                        data-password-toggle="contrasena_actual"
            ...
            <div class="col-lg-4">
                ...
                <div class="password-input-wrap">
                    ...
                    <button
                        type="button"
                        data-password-toggle="nueva_contrasena"
                        aria-label="Mostrar contraseña"
                    >
                        <i class="bi bi-eye"></i>
                    </button>
            ...
            <div class="col-lg-4">
                ...
                <div class="password-input-wrap">
                    ...
                    <button
                        type="button"
                        data-password-toggle="confirmar_contrasena"
                        aria-label="Mostrar contraseña"
                    >
                        <i class="bi bi-eye"></i>
                    </button>
